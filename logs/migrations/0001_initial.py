...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('logs_log', (
            ...
            ('logging', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('logs', ['Log'])

        # Adding M2M table for field user on 'Log'
        db.create_table('logs_log_user', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('log', models.ForeignKey(orm['logs.log'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('logs_log_user', ['log_id', 'user_id'])
    ...
    models = {
        ...
        'logs.log': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logging': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
